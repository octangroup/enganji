<template>
    <div class="w-60 xs:w-100 mx-auto  rounded-r-xlg border-1 border-solid border-grey-light  bg-grey-lightest">
        ...
        <div class="w-100 flex p-2 pt-0 " >
            ...
            <textarea  name="message" placeholder="Enter message.." class="border-0 rounded-l-full align-top py-2 px-3  h-10  pb-0 text-sm resize-none outline-none w-85  xs:w-80 shadow"></textarea>

            <button  type="submit" class="btn bg-primary rounded-r-full text-white cursor-pointer text-xs align-top pr-3 mt-0 border-0 w-15 xs:w-30 shadow">
                Send
            </button>
        </div>
