            ...
            <div class="w-20 p-5">
                ...
                <div class="py-2 ">
                    ...
                    <div class=" w-100 flex py-1 m-0 mx-3">
                        <div class="h-8 w-8 rounded-full border-black border-solid border-1 text-center text-sm py-1 mx-1">
                            2.4
                        </div>
                        <div class="h-8 w-8 rounded-full border-black border-solid border-1 text-center text-sm py-1 mx-1">
                            2.4
            ...
            <div class="w-80 bg-white ">
                ...
                @foreach($products as $product)
                    <div class="flex bg-white rounded w-70 mx-5 m-3 mb-4 p-2 border-1 border-solid border-grey-light">
                        ...
                        <div class="w-70 my-3">
                            <a href="{{action('ProductsController@show',[$product->id,kebab_case($product->name)])}}">
                            <h3 class="text-sm my-1">{{$product->name}} </h3>

                            <span class="text-xs my-0 text-grey">by {{$product->affiliate->name}}</span>
                        ...
                        <span class="text-orange mt-2">
                            ...
                            <div>
                                <p class="text-base font-semibold text-red  mt-2 ">{{$product->currency->name}} {{$product->price}}</p>
                            </div>
                            </a>
                        </div>
