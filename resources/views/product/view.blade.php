...
@section('content')
        ...
        <div class="panel-body w-90 md:w-80 mx-auto">
            <div class="xl:flex ">
                ...
                {{--</div>--}}
                    ...
                    <div class="w-30 mt-3 hidden xl:block">
                    ...
                    <div class="w-100 lg:hidden  mb-5 ">
                        ...
                        <div class=" md:w-70 md:mx-auto border border-solid border-grey-light rounded-xlg overflow-hidden mt-3">
                            <img src="{{$product->cover()}}" class="transition-500ms ">
                ...
                <div class="xl:w-50 xs:w-80 md:w-50 xl:mx-5 xs:mt-4">
                    ...
                    <div class="mt-3 xs:hidden md:hidden">
                        ...
                        <p class="text-black mx-2 text-xs xs:hidden md:hidden  mt-2 inline-block">{{$product->reviews->count()}} reviews</p>
                    </div>
                    ...
                    <div class="w-100  text-base ">
                        ...
                        <form action="{{action('CartController@store')}}" method="post" class="xl:w-50 xs:w-100 md:w-100">
                            {{csrf_field()}}
    ...
    <div class="panel panel-default">
        <div class="xl:mt-3 w-80 mx-auto">   
