...
@section('content')
<div class="container">
    <div class="bg-white py-5  border-1 border-solid border-grey-light my-5 w-50 xs:w-100 mx-auto rounded-lg">
        <div class="w-75 mx-auto mb-5 pt-3">
            <div class="w-50 mx-auto text-center mb-5">

                <h4 class="font-primary">Register</h4>
            </div>
                    <form class="form-horizontal w-80 xs:w-100 sm:w-100 md:w-100 mx-auto mt-5" role="form" method="POST" action="{{ route('affiliate.register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="w-70 xs:w-100 text-right">
