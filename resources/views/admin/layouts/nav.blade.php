@if(Auth::guard('admin')->check())
    <div class="xs:flex md:flex">
        <div class=" my-3 xs:w-50 md:w-10 xl:hidden lg:hidden">
        ...
        <div class="w-100 xs:w-50 md:w-80 mx-auto flex">
            <div class="bg-transparent xs:hidden mt-2 my-4 md:my-2 w-80">
                @if($has_search ?? null)
                    <form name="search_form" action="{{$search_url ?? null}}" method="get" class="w-50 md:w-100 mx-auto text-right text-center mt-2">
                        <div
            ...
            <div class="w-20 flex align-items-center md:px-5 justify-content-end py-4">
                <div class="w-100 flex align-content-end">
                    ...
                    <div class="my-0 ml-3 cursor-pointer dropdown z-999">
                        <p class="my-0 font-primary font-medium">{{ \Illuminate\Support\Str::title(Auth::guard('admin')->user()->name) }}
                            <i class="ml-2 -mt-1 xs:hidden fas fa-angle-down"></i></p>
