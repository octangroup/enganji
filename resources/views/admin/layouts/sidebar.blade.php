    ...
    <div class="mt-2">
        ...
        <div class="w-70 mx-auto my-0  flex text-base">
            ...
            <div class="w-75 flex align-items-center">
                <p class="w-75   font-primary my-3">Dashboard</p>
            </div>
        </div>
        <div class="w-70 mx-auto   flex text-base ">
            ...
            <div class="w-75 flex align-items-center">
                <p class="w-75  font-primary my-3"> Product</p>
            </div>
        </div>
        <div class="w-70 mx-auto  flex text-base">
            <div class="w-25 ">
            ...
            <div class="w-75 flex align-items-center">
                <p class=" my-3 font-primary ">Deal</p>
            </div>
        ...
        <div class="w-70 mx-auto flex text-base">
            ...
            <div class="w-75 flex align-items-center">
                <p class="my-3 font-primary ">Affiliate</p>
            </div>
        ...
        <div class="w-70 mx-auto  flex text-base">
            ...
            <div class="w-75 flex align-items-center">
                <p class=" my-3 font-primary ">Config</p>
            </div>
        ...
        <div class="w-70 mx-auto  flex text-base">
            ...
            <div class="w-75 flex align-items-center ">
                <p class=" my-3 font-primary ">Ads</p>
            </div>
