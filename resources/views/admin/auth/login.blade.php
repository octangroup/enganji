                ...
                <form method="POST" action="{{ route('admin.login') }}">
                    ...
                    <div class="border-1 border-solid border-grey relative mb-4">
                        ...
                        <input id="password" type="email"
                               class="form-input{{ $errors->has('password') ? ' is-invalid' : '' }} my-0 border-none px-3 w-100 py-1 relative shadow-none py-0 mt-2 rounded-none"
                               autocomplete="false"
                               name="email"
                               required>
                    </div>
                    <div class="border-1 border-solid border-grey relative mt-4">
                        ...
                        <input id="password" type="password"
                               class="form-input{{ $errors->has('password') ? ' is-invalid' : '' }} my-0 border-none w-100 py-1 relative px-3 shadow-none py-0 mt-2 rounded-none"
                               name="password"
                               required>
                    </div>
